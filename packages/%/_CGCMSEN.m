...
GO D ^%CGENSEM
FIN K CTRLA,DX,DXD,DXG,DY,DYB,DYH,%ENS,GRAPH,MSG,Y1 Q
CAD S DXG=0,DXD=39,DYH=0,DYB=4,GRAPH=1,MSG="MODIF. DES CARACTERES SPECIAUX"
 D 4^%VZCD Q
