...
;%QCAGTU4^INT^1^59547,73875^0
TREEWAYR ;
 
 
 S STOP=0,%2I=$S(NOMTREE["(":NOMTREE_")",1:NOMTREE) I ($D(@%2I)#10)=1 S (%1C,%TREFC)="" D @%TAD Q:STOP'=0
 S %2I=$S(NOMTREE["(":NOMTREE_",",1:NOMTREE),%2V=0,%2P=1 F %2Z=0:0 S %2P=$F(%2I,",",%2P) Q:%2P=0  S %2V=%2V+1
 S %2IPR=%2V+1 K %2V,%2P,%2I,%2Z S %1G=NOMTREE_$S(NOMTREE["(":")",1:""),%2G=NOMTREE_$S(%1G[")":",",1:"(")_"%2,",%2="" F %1=1:1 S (%PR,%2PR)=%2IPR,%2=$O(@%1G@(%2)) Q:%2=""  D AFFR Q:STOP=1
...
ECR W !,%TREFC S %98U=%98U+1 S:%98U=1500 STOP=1 Q
