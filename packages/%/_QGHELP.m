...
;%QGHELP^INT^1^59547,73876^0
%QGHELP ;
 D CLEPAG^%VVIDEO S SCR="QGHELP" D ^%VAFIGRI,CUROF^%VVIDEO,POCLEPA^%VVIDEO W "[RETURN]",*-1 R *BIDON
 D CLEPAG^%VVIDEO,SMTHSCRL^%VVIDEO,TEXTE,POCLEPA^%VVIDEO W "[RETURN] pour continuer " R *BIDON D JMPSCRL^%VVIDEO,CURON^%VVIDEO,SCREESH^%QGECRAN S RETOUR=1 Q
 
TEXTE S DX=20,DY=20,DX=$X-1,NU=1 X XY W " ",!,! F I=1:1 S A=$T(FUN+I) Q:A=""  S CHOI=$P(A,";;",2) W:CHOI'="*" !,CHOI I CHOI="*" D ^%VZEAVT("")
 Q
FUN ;;
 ;;GENERALITES
 ;;-----------
