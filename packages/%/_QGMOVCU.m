...
;%QGMOVCU^INT^1^59547,73876^0
GRMOVCUR S IOM=80,%COTE="" O 0 U 0,0,0
...
LOOP R *X1:ATT S:X1=-1 X1=13
 ...
 ;;FINNONDTM
 ;;DTM
 I $$FLECHE^%INCCLAV(X1,.X1,.X2,.X3) D @X3 Q:%COTE'=""  D TEST G LOOP
...
ECRI R *Y
 ...
 ;;FINNONDTM
 ;;DTM
 I $$FLECHE^%INCCLAV(Y,.X1,.X2,.X3) D @X3 Q:%COTE'=""  D TEST G LOOP
