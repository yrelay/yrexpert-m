...
;%QGPAGE^INT^1^59547,73876^0
GRPAGE ;
MOING S RETOUR=2 Q:PAG=1  S PAG=PAG-1 D APG^%QGPAG S DX1=2,DY1=6 Q
PLUG S RETOUR=2 Q:NBPAG=PAG  S PAG=PAG+1 D APG^%QGPAG S DX1=2,DY1=6 Q
NOPG S RETOUR=2,DX=6,DY=3 X XY W *-1 S XXX=$C(X1) W XXX S DX=DX+1 X XY D ^%VLEC S Y1=XXX_Y1 G:CTRLA FIN1 Q:CTRLF  D NUM D:NUM'=1 APG^%QGPAG S RETOUR=2 Q:NUM'=1
 ...
 S PAG=Y1 D APG^%QGPAG S DX1=2,DY1=6 Q
MOIND S RETOUR=2 Q:PAD=1  S PAD=PAD-1 D APD^%QGPAG S DX1=42,DY1=6 Q
PLUD S RETOUR=2 Q:NBPAD=PAD  S PAD=PAD+1 D APD^%QGPAG S DX1=42,DY1=6 Q
NOPD S RETOUR=2,DX=46,DY=3 X XY W *-1 S XXX=$C(X1) W XXX S DX=DX+1 X XY D ^%VLEC S Y1=XXX_Y1 G:CTRLA FIN1 Q:CTRLF  D NUM D:NUM'=1 APD^%QGPAG S RETOUR=2 Q:NUM'=1
 ...
 S PAD=Y1 D APD^%QGPAG S DX1=42,DY1=6 Q
FIN1 S RETOUR=1 Q
