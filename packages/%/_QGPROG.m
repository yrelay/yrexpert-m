...
;%QGPROG^INT^1^59547,73876^0
%QGPROG ;;02:26 PM  27 Oct 1992; ; 30 Mar 93  4:06 PM
...
INT(NOMLISTE,LISTATT,ATTTOL,TITRE) 
 N LISTES,TEMP,CTR,STOCK1,CREA1,STOCK,CREA,LISRES,CUSTOM
...
STO(LLISTE) 
 N ADRESSE,LL,%L
 D ^%QGSTO(LLISTE)
 S LISRES=$$GEN^%QCAPOP("GRP")
 S ADRESSE="^[QUI]RQS2("""_LISRES_""",""OBJET"")"
 D CREERL^%QS0XG1(LISRES,"L0",ADRESSE,"GROUPAGE","GROUPAGE")
 S LL="" F %L=0:0 S LL=$O(@LLISTE@(LL)) Q:LL=""  D AJOUT^%QS0XG1(LISRES,LL)
 Q
