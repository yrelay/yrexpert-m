...
;%VMODISC2^INT^1^59547,74035^0
%VMODISC2(PAGE) ;;02:51 PM  20 Dec 1996
...
BEG I SCR="MOZCONF" S:PAGE=1 ICC=$$INIT^%VCURGRI S:PAGE=2 ICC=41 S:PAGE=3 ICC=81 S:PAGE=4 ICC=121 G FIN:ICC=0
 I SCR="MZCONF2" S:PAGE=1 ICC=$$INIT^%VCURGRI S:PAGE=2 ICC=41 S:PAGE=3 ICC=81 S:PAGE=4 ICC=121 G FIN:ICC=0
 I SCR="MOZLIGN1" S:PAGE=1 ICC=$$INIT^%VCURGRI S:PAGE=2 ICC=21 S:PAGE=3 ICC=41 S:PAGE=4 ICC=61 G FIN:ICC=0
 I SCR="MOZLIGN2" S:PAGE=1 ICC=$$INIT^%VCURGRI S:PAGE=2 ICC=19 S:PAGE=3 ICC=37 S:PAGE=4 ICC=55 G FIN:ICC=0
...
ICCP1 D LOP3,NORM^%VVIDEO G ABEND:ABENDSCR=1,LOP:ESCMV=1
 S ICC=$$^%VCURGRI2(ICC,67,PAGE) G LOP
FIN Q
...
CAO D VERIF G REFULOP:REFUSE>0 S STOPUC=0 I $D(CMS),CMS'=1,$D(^%SCRE(SCR,ICC,4)),^%SCRE(SCR,ICC,4)'="" K FRESU(ICC) F UYT=1:1 S UCONT=$P(^%SCRE(SCR,ICC,4),",",UYT) Q:UCONT=""  S IC=ICC D @UCONT G REFULOP:REFUSE>0 Q:STOPUC=1
 Q
ABEND S ABENDSCR=1 Q
UCONT Q:'($D(^%SCRE(SCR,ICC,4)))  Q:^%SCRE(SCR,ICC,4)=""  S UCONT=^%SCRE(SCR,ICC,4) Q:UCONT=""  S IC=ICC D @UCONT Q
ESCMV S ESCMV=1
 S ICC=$$^%VCURGRI2(ICC,$P(CTRLF,"*",2),PAGE) 
 I SCR="MOZCONF" I PAGE=2 I ICC=40 S PAGE=1 S ICC=0 S ABENDSCR=1 Q 
 I SCR="MOZCONF" I PAGE=3 I ICC=80 S PAGE=2 S ICC=0 S ABENDSCR=1 Q 
 I SCR="MOZCONF" I PAGE=4 I ICC=120 S PAGE=3 S ICC=0 S ABENDSCR=1 Q 
 
 I SCR="MZCONF2" I PAGE=2 I ICC=40 S PAGE=1 S ICC=0 S ABENDSCR=1 Q 
 I SCR="MZCONF2" I PAGE=3 I ICC=80 S PAGE=2 S ICC=0 S ABENDSCR=1 Q 
 I SCR="MZCONF2" I PAGE=4 I ICC=120 S PAGE=3 S ICC=0 S ABENDSCR=1 Q 
 
 I SCR="MOZLIGN1" I PAGE=2 I ICC=20 S PAGE=1 S ICC=0 S ABENDSCR=1 Q 
 I SCR="MOZLIGN1" I PAGE=3 I ICC=40 S PAGE=2 S ICC=0 S ABENDSCR=1 Q 
 I SCR="MOZLIGN1" I PAGE=4 I ICC=60 S PAGE=3 S ICC=0 S ABENDSCR=1 Q 
 
 I SCR="MOZLIGN2" I PAGE=2 I ICC=18 S PAGE=1 S ICC=0 S ABENDSCR=1 Q 
 I SCR="MOZLIGN2" I PAGE=3 I ICC=36 S PAGE=2 S ICC=0 S ABENDSCR=1 Q 
 I SCR="MOZLIGN2" I PAGE=4 I ICC=54 S PAGE=3 S ICC=0 S ABENDSCR=1 Q 
 ;;S ICC=$$^%VCURGRI(ICC,$P(CTRLF,"*",2))
 Q
...
NDISP D ^%VZEAVT($$ZW("DESOLE !! NON ENCORE DISPONIBLE... ")) G FIN
CTRL() N CTR,%U,IT
