...
;%VMULRES^INT^1^59547,74035^0
GEMULRES(SC) 
 
 K RESUL,AFRESU,PATOUCH,DEJALU
REST G:'($D(^MULSAV($J,SC))) FIN S %1G="^MULSAV($J,SC)",%2="" F %0=1:1 S %2=$O(@%1G@(%2)) Q:%2=""  K @(%2)
 S %2G="^MULSAV($J,SC,%2,",%2="" F %1=1:1 S %2=$O(@%1G@(%2)) Q:%2=""  D AFFR
 K ^MULSAV($J,SC),%0,%2G,%2,%1,%2P,%1G,%2S,%3S,%1Z,%2L Q
