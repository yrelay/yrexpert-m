...
;%VMULSAV^INT^1^59547,74035^0
GEMULSAV(SC) 
 
SAVE K ^MULSAV($J,SC) S %="%2",%3=$P($T(SAV),";;",2) F %4=1:1 S %2=$P(%3,",",%4) Q:%2=""  D AFF
FIN0 K %,%0,%1,%2,%11,%12,%1G,%2P,%3S,%2S,%3,%4
FIN Q
AFF I ($D(@%2)#10)=1 S ^MULSAV($J,SC,%2)=@%2
 I $D(@%2)=1 G END
 I ($D(@%2)\10)=1 D ARRAY
END S %=%2 G FIN
ARRAY S %1G="^MULSAV($J,SC,%2,",%2P=%2_"(",%2S="%3S)"
