...
TEST
 W !,"ABCDEF"
 S C=1 D COLOR^%VVIDEO3(C,0) W !,C," - ","ABCDEF"
 S C=2 D COLOR^%VVIDEO3(C,0) W !,C," - ","ABCDEF"
 S C=3 D COLOR^%VVIDEO3(C,0) W !,C," - ","ABCDEF"
 S C=4 D COLOR^%VVIDEO3(C,0) W !,C," - ","ABCDEF"
 S C=5 D COLOR^%VVIDEO3(C,0) W !,C," - ","ABCDEF"
 S C=6 D COLOR^%VVIDEO3(C,0) W !,C," - ","ABCDEF"
 S C=7 D COLOR^%VVIDEO3(C,0) W !,C," - ","ABCDEF"
 S C=8 D COLOR^%VVIDEO3(C,0) W !,C," - ","ABCDEF"
 S C=9 D COLOR^%VVIDEO3(C,0) W !,C," - ","ABCDEF"
 S C=10 D COLOR^%VVIDEO3(C,0) W !,C," - ","ABCDEF"
 S C=11 D COLOR^%VVIDEO3(C,0) W !,C," - ","ABCDEF"
 S C=12 D COLOR^%VVIDEO3(C,0) W !,C," - ","ABCDEF"
 S C=13 D COLOR^%VVIDEO3(C,0) W !,C," - ","ABCDEF"
 S C=14 D COLOR^%VVIDEO3(C,0) W !,C," - ","ABCDEF"
 S C=15 D COLOR^%VVIDEO3(C,0) W !,C," - ","ABCDEF"
 S C=16 D COLOR^%VVIDEO3(C,0) W !,C," - ","ABCDEF"
 S C=17 D COLOR^%VVIDEO3(C,0) W !,C," - ","ABCDEF"
 S C=18 D COLOR^%VVIDEO3(C,0) W !,C," - ","ABCDEF"
 S C=19 D COLOR^%VVIDEO3(C,0) W !,C," - ","ABCDEF"
 S C=20 D COLOR^%VVIDEO3(C,0) W !,C," - ","ABCDEF"
 S C=21 D COLOR^%VVIDEO3(C,0) W !,C," - ","ABCDEF"
 S C=22 D COLOR^%VVIDEO3(C,0) W !,C," - ","ABCDEF"
 S C=23 D COLOR^%VVIDEO3(C,0) W !,C," - ","ABCDEF"
 S C=24 D COLOR^%VVIDEO3(C,0) W !,C," - ","ABCDEF"
