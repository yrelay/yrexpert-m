...
FIN1 K ^%SCRE(SCR),CMS O 0
 G FS:ABENDSCR=1
DESAC D CLEPAG^%VVIDEO S DX=0,DY=10 X XY W $$L15^%QSLIB1,!,!,$$^%QZCHW("- ") S DY=DY+2,DX=$X D ^%VLEC G LOOP:CTRLA=1,ACTIV:CTRLF=1 S:Y1="" Y1=0 S %DESAC=Y1
