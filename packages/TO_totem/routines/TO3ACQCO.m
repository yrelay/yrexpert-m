...
DESAC S %DESAC=0
 D LOOP2,CLEPAG^%VVIDEO S DX=0,DY=10 X XY W $$^%QZCHW("Recherche en cours....") D ^TO3GEQUI,^TO4EDICO W !,!,$$^%QZCHW("RETURN") R *RET D CLEPAG^%VVIDEO G ACTIV
