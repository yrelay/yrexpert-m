...
TO3IGNOR ;
 ...
 K NPASSO,RPASSO,%NBASS,%QZ,%GG,%VALE,PASSO,NUM,RS,%RS,WWQ,NOMTAB,%NOM,PRX,%CP,%MODA,%CPTASS
FIN Q
GETDEP S NOMTAB="^[QUI]EXPGIMP(%CP,%VALE)",NUM=-1 F %GG=0:0 S NUM=$N(@NOMTAB@(NUM)) Q:NUM=-1  D TRAIT
 G FIN
