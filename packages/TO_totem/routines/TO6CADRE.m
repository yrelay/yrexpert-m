...
;TO6CADRE^INT^1^59547,74871^0
TO6CADRE ;
 
 D CUROF^%VVIDEO,G0ON^%VVIDEO S LIP="" F QA=DXG:1:DXD S LIP=LIP_"`"
 ...
 D G0OFF^%VVIDEO S DY=(DYH+DYB)\2,DX=((DXG+DXD)\2)-($L(MSG)\2) X XY W MSG
FIN D CURON^%VVIDEO Q
