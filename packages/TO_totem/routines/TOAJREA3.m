...
EXPLIC I '($D(^DON($I,PAR))) G IMP
 S ORD=^DON($I,PAR),EV=^[QUI]EXPLICIT(YA,ORD,PAR),PH=$S(PY>14:8,1:14),DE=PH,FI=DE+7 D ^%ABNETTO S DXG=0,DXD=79,DYH=PH,DYB=PH+7,GRAPH=0,MSG="" D TO4^%VZCD
