...
;TODUPBI2^INT^1^59547,74871^0
TODUPBIS ;
 
 
 K ^BISIMP($I,NUFAC),^INDEF($I,NUFAC) S %TAD="T0^TODUPTAB",NOMTREE="^BISIMP($I,NUFA" D ^%QCAGTU5
...
L5 S %NB5=$N(@%TB@(%NB1,%NB2,%NB3,%NB4,%NB5)) G:%NB5=-1 L4
 ...
 G L5
FIN K %TAD,DATAC,%TB,%NB1,%NB2,%NB3,%NB4,%NB5 Q
T0 S DATAC=@(NOMTREE_","_%TREFC_")"),@("^BISIMP($I,NUFAC,"_%TREFC_")")=DATAC Q
