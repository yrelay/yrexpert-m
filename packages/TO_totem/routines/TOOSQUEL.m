...
L K T,LOCA,MA,MI S IX=1
 F I=":","""",";",",","'","^","%","_","#","+","*","-","/","\","[","]","(",")","&","!","<",">","=" S POSI=1 F Z1=0:0 S POSI=$F(XDP,I,POSI) Q:POSI=0  S LOCA(IX)=POSI-1,T(LOCA(IX))=I S:I="[" MI(POSI-1)=IX S:I="]" MA(POSI-1)=IX S IX=IX+1
 G FIN
...
TEST S ADRF="ADR" W !,$$^%QZCHW("A tester : ") R XDP Q:XDP=""
 S XDP="("_XDP_")" D ^TOOSQUEL W !,?10,EX G TEST
