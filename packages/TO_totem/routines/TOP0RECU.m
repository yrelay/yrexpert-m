...
;TOP0RECU^INT^1^59547,74874^0
TOP0RECU ;
 S %TB="^[QUI]P0GETARC"
XXX D POCLEPA^%VVIDEO W "Un instant..." S %JO=$J,DT=-1 K ^UTILITY(%JO)
 F %U=1:1 S DT=$N(@%TB@(DT)) Q:DT=-1  S DAT=$E(DT,5,6)_"/"_$E(DT,3,4)_"/"_$E(DT,1,2),HE=-1 F %V=1:1 S HE=$N(@%TB@(DT,HE)) Q:HE=-1  S HH=$TR(HE,".","H"),^UTILITY(%JO,DAT_" "_HH)=1
