...
;TOTROBJ^INT^1^59547,74876^0
TOTROBJ ;
 
 D POCLEPA^%VVIDEO S PDL=$$L23^%QSLIB2("D destruction,CTRLG gomme") W PDL S DX=0,PY=7
DEB S MPASX=0,MPASY=1,NXI=-1,NXS=79,NYI=7,NYS=21
DEB1 S DY=PY+1 S:DY>20 (DY,PY)=20 S DX=0 X XY D ^%VZECUR G:X1=1 1 S PY=$Y
 G:'($D(^POSENR($I,PAGE,PY))) DEB1 G:(X1'=1)&((X1'=7)&(X1'=68)) DEB1
 G @X1
FIN Q
