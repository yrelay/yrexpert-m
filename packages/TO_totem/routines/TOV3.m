...
;TOV3^INT^1^59547,74876^0
TOV3 ;
 
 W !,!,$$^%QZCHW("Module 3 de verification des donnees"),!,?5,$$^%QZCHW("Full match/controles/resaisie des fiches")
 ...
 K %A,%NU,%TAB,%TB,%UU,%VV S %CHOIX="R" D BEG^TOSAISIM
