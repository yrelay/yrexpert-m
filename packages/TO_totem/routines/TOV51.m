...
;TOV51^INT^1^59547,74876^0
TOV51 ;
 
 W !,!,$$^%QZCHW("Module 5.10 de verification des donnees"),!,?5,$$^%QZCHW("Comprehension de toutes les matieres")
 ...
 K %A,%NU,%TAB,%TB,%UU,%VV S ^VERIF($I)=1,TO3CPMAX="^TO3CPMAT" D BEG^TO3COMAX
...
SUIT D CURRENT^%IS,VARSYS^%QCSAP,BEG^TOV511
