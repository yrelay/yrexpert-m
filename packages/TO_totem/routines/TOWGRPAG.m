...
;TOWGRPAG^INT^1^59547,74876^0
TOWGRPAG ;
 
PGE S PGE=DP*10
 G FIN
DP S DP=PGE/10 S:DP<1E-1 DP=1E-1
 G FIN
AFFICH S:'($D(AFTIM)) AFTIM=1 S ADX=DX,ADY=DY,DX=60,DY=23 X XY W $$^%QZCHW("                 ") X XY W $$^%QZCHW("Page : ") S XCU=$X W PGE
