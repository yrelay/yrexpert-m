...
;%ABCOLON^INT^1^59547,73864^0
%ABCOLON ;
 
 S LCHP=(70\NBC)-1,LIMC="",LIMS="",ESP=1 F II=1:1:NBC S LIMC=LIMC_":",LIMS=LIMS_":" F IJ=1:1:LCHP S LIMC=LIMC_" ",LIMS=LIMS_"-"
 S LIMC=LIMC_":",LIMS=LIMS_":",VC2=(LCHP-1)\2,LARCOL=LCHP Q
TEST W $$^%QZCHW("Nombre de colonne : ") R NBC Q:NBC=""  D %ABCOLON W !,?9,LIMC,! G TEST
DEO 
