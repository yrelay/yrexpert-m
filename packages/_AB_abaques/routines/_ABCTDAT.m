...
;%ABCTDAT^INT^1^59547,73864^0
%ABCTDAT ;
 
 D DAT Q:REFUSE=1  S TAB(ICC)=DAAT D ^%ABAFFIU Q
DAT S JR=RESUL(IC)
 ...
 G FINCTR
REFUDAT S DAAT="" D ^%VSQUEAK S PADMESSA=$$^%QZCHW("      svp date  JJ/MM/AA    exemple 13/08/83               ") D PAD^%VZEATT H 1 S DX=0,DY=23 X XY D CLEBAS^%VVIDEO S REFUSE=1
 Q
NORMDA 
