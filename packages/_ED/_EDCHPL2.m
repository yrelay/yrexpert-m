...
;%EDCHPL2^INT^1^59547,73868^0
%EDCHPL2 ;;06:23 PM  23 Apr 1992;
...
LIGNE 
 ...
 I Y1>Y2 S SENSY=-1
 I X1=X2 D VERT^%EDCHPL(X1,Y1,X1,Y2,EPA) Q
 I Y1=Y2 D HORI^%EDCHPL(X1,Y1,X2,Y1,EPA) Q
...
BOUCLE 
 ...
 D:SIN'>5E-1 HORI^%EDCHPL(%9X1,%9Y1,%9X2,%9Y1,EPA)
 D:SIN>5E-1 VERT^%EDCHPL(%9X1,%9Y1,%9X1,%9Y2,EPA)
...
CERCLE 
 ...
 S A=5
 I $$^%QCAZG("%DESSIN")=1 S X=635E-5*%9X,R=635E-5*%9R,Y=%LIMYCM-(635E-5*%9Y)
 S:R<5E-1 A=2
...
QUART 
 ...
 S X=635E-5*%9X,Y=%LIMYCM-(635E-5*%9Y),R=635E-5*%9R
 S AD=%9AD,AF=%9AF
 S %FONC="ARC" D ^%PBPZ
