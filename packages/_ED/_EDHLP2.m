...
FIN K @(MN1)
 ...
 ;;%X = coordonne hor.
 ;;%Y = coordonnee vert.
 ;;%TAILLE = numero de la police de caractere
 ;;%EPAISSEUR = epaisseur du trait en millimetre
 ;;%ORIENTATION = "HORIZONTALE" ou "VERTICALE" (pour dessins)
 ;;*
 ;
