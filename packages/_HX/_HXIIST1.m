...
;%HXIIST1^INT^1^59547,73869^0
HXIIST1(X,Y,H,L,LC,E,CL) 
 ...
 D CLFEN^%VVIDEO(X,Y,H,L),REV^%VVIDEO
...
TEST K CLO S CLO=12 F M=1:1:CLO S CLO(2,M)=0,CLO(1,M)=$$RNZE(CLO(2,M)+1,25)
 D ^%HXIIST1(5,5,15,50,5,1,"CLO"),CARSP^%VVIDEO(4,4,17,52),^%VZEAVT("")
 Q
