...
LKYVALI() 
 ...
 S MSG=$$^LKNMINIT($$CONCAS^%QZCHAD("^DAT",BASE),BASE)
...
T S LIEN=$$POP^LKZSTACK(PILE)
 ...
 S LIEN1=$$NOMINT^%QSF($$^LKNMLIEN(LIEN,.INTERD))
 I LIEN1="" S LIEN=$$POP^LKZSTACK(PILE) Q
 S MSG=$$^LKNMINIT($$CONCAS^%QZCHAD("^DAT",LIEN1),LIEN1)
