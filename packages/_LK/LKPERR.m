...
LKP ;;|VT|" Valeur(s) Tronquee(s) "|
 ;;|UP|" Protocole pas supporte "|
 ;;|UIP|" Protocole pas installe "|
 ;;|VIM|" Vecteur d'initilisation manquant "|
 ;;|NO|" Device not Open "|
 ;;|EOF|" End of File "|
