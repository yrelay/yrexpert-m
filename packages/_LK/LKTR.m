...
;LKTR^INT^1^59547,74867^0
LKTR(AS,NS,DS,AD,ND,DD,PROT,VECT,ID,IF) 
 ...
 F I="ID","IF" S:@I="" @I=""""""
 S @("ER=$$"_@PVECT@("FCT")_"("_ID_","_IF_")")
 K @(TEMP)
 Q ER
 
TEST K ^[QUI]LK("AVEX","M1","D") B
 S ER=$$LKTR("AVEX","M","D","AVEX","M1","D","TRST","AVEX2^LKTLAVEX","","")
 W !,ER
 Q
