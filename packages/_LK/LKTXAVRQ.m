...
ST1 S ER=$$LOA^LKZPAR(TEMP,PARA,1,.VAL)
 D:((ER=0)&(PARA'="ARC"))&(PARA["AVIS.EXPEDITION") PA^%QSGESTI("EXPEDITION",AVEX,PARA,VAL,1)
 D:((ER=0)&(PARA'="ARC"))&(PARA'["AVIS.EXPEDITION") PA^%QSGESTI("EXPEDITION",AVEX,PARA,VAL,ARC)
 Q
TEST D ^LKTXAVRQ("","")
 Q
