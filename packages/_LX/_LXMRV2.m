...
FIN Q:MN="MNVIS"
 ...
 S MN="MNVIS",SCR="MOTRESAI"
 G BOUC
 
 
MOT I CLE2="" D ^%VSQUEAK G BOUC
 I '($D(^MOTRES(CLE2))) D ^%VSQUEAK G BOUC
 S RESUL(1)=CLE2,LIG=^MOTRES(CLE2)
...
SUIVF1() S CLE2=$O(^MOTRESAI(CLE1,CLE2))
 G:CLE2'="" AFFEC
 S CLE1=$O(^MOTRESAI(CLE1))
 G:CLE1="" ERRSU
 S CLE2=$O(^MOTRESAI(CLE1,""))
 G AFFEC
...
SUIV12 I '($D(^MOTRESAI(CLE1))) S CLE1=$O(^MOTRESAI(CLE1)) G:CLE1="" ERRSU S CLE2=""
 I CLE2="" S CLE2=$O(^MOTRESAI(CLE1,"")) G:CLE2="" ERRSU G AFFEC
 G:$D(^MOTRESAI(CLE1,CLE2)) AFFEC
 S CLE2=$O(^MOTRESAI(CLE1,CLE2))
 G:CLE2="" ERRSU
 G AFFEC
...
SUIVF2() S CLE2=$O(^MOTRESY(CLE1,CLE2))
 G:CLE2="" ERRSU
 G AFFEC2
...
SUIV22 I '($D(^MOTRESY(CLE1,CLE2))) S CLE2=$O(^MOTRESY(CLE1,CLE2))
 G:CLE2="" ERRSU
 G AFFEC2
