...
BOUCINI F I=CLEDEP:1:NBCLE S RESUL(I)=""
 ...
 I SCR="MOTREUA" G:'($$SUIVA2) BOUCINI
 I SCR="MOTREUY" G:'($$SUIVA3) BOUCINI
...
CONS S:MN="MNVIS" I=$$SUIVF1
 S:SCR="MOTREUA" I=$$SUIVF2
 S:SCR="MOTREUY" I=$$SUIVF3
 G BOUC
...
FIN Q:MN="MNVIS"
 ...
 S MN="MNVIS",SCR="MOTREU"
 G BOUC
 
 
 
SUIVF1() S CLE1=$O(^MOTREU(CLE1))
 G:CLE1="" ERRSU
 G AFFEC
...
SUIV12 I '($D(^MOTREU(CLE1))) S CLE1=$O(^MOTREU(CLE1))
 G:CLE1="" ERRSU
 G AFFEC
 
 
SUIVF2() S CLE2=$O(^MOTREUA(CLE1,CLE2))
 G:CLE2="" ERRSU
 G AFFEC2
 
SUIVA2() S CLE2=RESUL(2)
 G:CLE2'="" SUIV22
 S CLE2=$O(^MOTREUA(CLE1,""))
 G:CLE2="" ERRSU
 G AFFEC2
 
SUIV22 I '($D(^MOTREUA(CLE1,CLE2))) S CLE2=$O(^MOTREUA(CLE1,CLE2))
 G:CLE2="" ERRSU
 G AFFEC2
 
 
SUIVF3() S CLE2=$O(^MOTREUY(CLE1,CLE2))
 G:CLE2="" ERRSU
 G AFFEC2
...
SUIV32 I '($D(^MOTREUY(CLE1,CLE2))) S CLE2=$O(^MOTREUY(CLE1,CLE2))
 G:CLE2="" ERRSU
 G AFFEC2
