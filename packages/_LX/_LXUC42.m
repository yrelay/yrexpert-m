...
;%LXUC42^INT^1^59547,73871^0
%LXUC42 ;;03:11 PM  20 Dec 1996
 ;; Cao-Thang
 ;; Modif pour GRILLE MOZART a plusieurs page
...
LEX D ^%LXUC72 G FIN
BREV S OICC=IC D ^%LXCONS,^%VAFIGRI2(PAGE),^%VAFISCR2(PAGE) S ICC=OICC,CTRLF=0 G FIN
