...
;%QFZOOM^INT^1^59547,73876^0
GRZOOM ;
ZOOM I AFFLIST=0 D ^%QFNONAF
...
LCPGZ S OBJ=$N(^[QUI]GROUPE(NUFA,1,GROZOOM,"OBJET",OBJ)) G:OBJ=-1 FLCPGZ D:LI=21 PLCPGZ S ^PAG($J,PAG,LI)=OBJ,LI=LI+1 G LCPGZ
PLCPGZ S PAG=PAG+1,NBPAG=PAG,LI=6 Q
FLCPGZ F I=LI:1:20 K ^PAG($J,PAG,I)
 S PAG=1 D APG^%QFPAG,CADRG^%QFECRAN Q
ZOFF S ARRET=NBPAG D CREPAG^%QFPAG
FLZOF S NBPAG=NBPAZ,NDLG=NDLGZ,PAG=1,ZOOM=0 D CADRG^%QFECRAN,APG^%QFPAG Q
FIN1 S RETOUR=1 Q
