...
;%QMCPOB^INT^1^59547,73876^0
QMCPOB ;
 
 N CTR,COPIE,DX,DY,MODE,MSG,MODAF,TEMP,SUP,IO,ADLK,STOP
 N XMODE,REAFF
 ...
 I (CTR="A")!(COPIE="") D FIN Q
 I COPIE="?" S COPIE=$$^%QUCHOYO($$ADR^%QMCPZ,.R,1) I COPIE="" D FIN Q
 D REAFF^%QMCP4(MODE)
 D SUP^%QMCPOZ1(.SUP,.IO,.STOP,REAFF)
 I STOP D FIN Q
 
 S XMODE=3
 S MSG=$$ACT^%QMCP6(COPIE,MODE,XMODE,SUP,IO)
