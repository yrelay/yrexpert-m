...
;%QMDAUTI^INT^1^59547,73877^0
%QMDAUTI ;;06:38 PM  30 Oct 1991; ; 24 Jun 92  6:35 PM
 
 
T N %TIM D INTT W %TIM Q
INTT N %M,%N,%I
 S %M=$P($H,",",2)\60
 S %N=" AM" S:%M'<720 %M=%M-720,%N=" PM" S:%M<60 %M=%M+720
 S %I=%M\600 S:'(%I) %I=" " S %TIM=%I_((%M\60)#10)_":"_((%M#60)\10)_(%M#10)_%N
 Q
 
 
D 
 N %DAT D INTD W %DAT Q
INTD S %DAT=$ZD($H,2)
 S %DAT=$P(%DAT," ",2)_" "_$P(%DAT," ",1)_" "_$P(%DAT," ",3)
 Q
