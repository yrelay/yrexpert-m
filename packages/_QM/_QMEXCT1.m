...
;%QMEXCT1^INT^1^59547,73878^0
%QMEXCT1 ;;03:44 PM  8 Dec 1992; 07 Dec 92  2:52 PM ; 15 Dec 92  4:57 PM
...
SAISIE(REP,IND,ATTCXT) 
 ...
 I $$^%QSCALIN(REP,IND,ATTCXT,1)="INDIVIDU" S VALDEF(1)=$$^%QSCALIN(REP,IND,ATTCXT,2),VALDEF(2)=$$^%QSCALIN(REP,IND,ATTCXT,3) F I=1:1:2 S:VALDEF(I)=" " VALDEF(I)=""
 S VALDEF="STOCK"
 ...
 D PA^%QSGESTI(REP,IND,ATTCXT,"INDIVIDU",1)
...
INIT 
 ...
 S @GLO@("POP1")="",@GLO@("POP2")=""
 S @GLO@("AIDE",1)=" [return] pour repertoire focus"_$C(0)_"ou nom d'un repertoire"_$C(0)_"ou attribut temporaire"
 S @GLO@("AIDE",2)=" [return] pour individu focus"_$C(0)_"ou nom d'un individu"_$C(0)_"ou attribut temporaire"
 ...
 S @GLO@("UCONT.CHAMPS",1)="D OK^%QMEXCT1"
 
 S @GLO@("UCONT.CHAMPS",2)="D OK^%QMEXCT1"
 S @GLO@("UCONT")=""
 
 S OBLIG="S OK=(VAL'="""")"
 F I=1:1:NBC S @GLO@("OBLIGAT",I)="S OK=1"
