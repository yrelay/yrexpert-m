...
ACT N ADRES,CONTR,LCOUR,FEN,TATA,TOTO D ^%QS3INIT
 ...
 S TOTO(2,"COM")=$$^%QZCHW("Lister les individus d'une liste")
 ...
 S TOTO(5,"COM")=$$^%QZCHW("Supprimer des listes")
 S TOTO(6)="+^PLUS",TOTO(8,"EQU")="="
 S TOTO(6,"COM")=$$^%QZCHW("Avancer d'une page")
 S TOTO(7)="-^MOINS",TOTO(9,"COM")=$$^%QZCHW("Reculer d'une page")
 S TOTO(8)=$$^%QZCHW("Page")_"^PAGE"
 S TOTO(8,"COM")=$$^%QZCHW("Changer de page")
 S TOTO(9)=$$^%QZCHW("Repere")_"^REPER"
 S TOTO(9,"COM")=$$^%QZCHW("Afficher le repere des pages")
 S LCOUR="" D PFEN
AFF2 D REAFF
AFF3 
...
GRAPH S R=$$^%QS0G4 G AFF2:R=2,AFF3:R=1,ACT2:1
