...
LISTR 
 S L=$$TEMP^%SGUTIL
 D LISTVAL^%QSTRUC8(RB,I,RATT,L) S LR=$$LISTIND^%QSGEST6(REPI)
...
REL G:'($D(@L@(SYN))) RELR
 ...
 I '($$CONFIRM^%VZEOUI($$^%QZCHW("Liaison deja existante. Recreation du lien ?"))) S FDM=1 G AJOUT
