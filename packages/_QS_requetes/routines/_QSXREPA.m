...
BQUERYV D REPARV1(%REP),CARD(%REP),^%QMTRAQS Q
BQUERY2 D REPAR21(%REP),CARD(%REP),^%QMTRAQS Q
BQUERY3 D REPAR31(%REP),CARD(%REP),^%QMTRAQS Q
BQUERY4 D REPAR41(%REP),CARD(%REP),^%QMTRAQS Q
