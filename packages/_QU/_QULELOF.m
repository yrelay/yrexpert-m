...
;! But         : Menu de l'éditeur de lien                                    !
;!                                                                            !
;! Description :                                                              !
;!                                                                            !
;!     DEF   : definir   : creer une nouvelle etude                           !
;!     CREER : lancer    : creer et lancer une nouvelle etude                 !
;!     REPR  : reprendre : reprendre une etude definie ou deja commencee      !
;!     SUPP  : supprimer : supprimer des etudes obsoletes                     !
;!                                                                            !
;!----------------------------------------------------------------------------!
...
%QULELOF ;
 ...
 S AFFICH=0,CALA=0,GLOB=$$ADRETU^%QULELOE
...
DEF S NUMET=$$CREERET^%QULELOE(0)
 D KILLAFF,CLEPAG^%VVIDEO,TETE S AFF=0
 G ACTH
CREER 
 S NUMET=$$CREERET^%QULELOE(0)
...
SUPP 
 ...
 S L=""
 F %T=1:1 S L=$O(@ENS@(L)) Q:L=""  S NUMET=$P(L," ",1) D SUPET^%QULELOE(NUMET)
 D KILLAFF,CLEPAG^%VVIDEO,TETE S AFF=0
 G ACTH
