...
CREER(FEN,XG,YH,HA,LA,LE,SC) G CR
...
NET Q:^ZPILF($J,FEN,"P")=0
 D OPEN^%SYSUTI1($I,^ZPILF($J,FEN,"LE"),""),CLFEN^%VVIDEO(^ZPILF($J,FEN,"XG"),^ZPILF($J,FEN,"YH"),^ZPILF($J,FEN,"HA"),^ZPILF($J,FEN,"LA")) Q
AD 
 D CLEAR^%SYSUTI1
 Q:'($D(^ZPILF($J,FEN)))
 S:'($D(^ZPILF($J,FEN,"P"))) ^ZPILF($J,FEN,"P")=0
