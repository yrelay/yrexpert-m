...
;%SGCOSTA^INT^1^59547,73890^0
%SGCOSTA ;;11:15 AM  4 Mar 1993; ; 04 Mar 93 11:17 AM
...
STBCL D MKAFF
 D AFF
 K @(STAT),@(TOT)
 F J=1:1:5000 I $$ISCTRLA^%SYSCLAV G STAFI
 G STBCL
 Q
...
CASE 
 ...
 S V=$S('($D(@TOT@(NATPB))):0,@TOT@(NATPB)=0:0,1:(V*100)\@TOT@(NATPB)),V="("_$S($L(V)=1:"  ",$L(V)=2:" ",1:"")_V_" %)" W ?16+(I*18),V S I=I+1
 Q
 ;
