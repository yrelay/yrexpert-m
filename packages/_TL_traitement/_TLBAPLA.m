...
REGSUI 
 ...
 I ECHEC=0 S @PLAN@(PERE,BONMAL,NUMRG)=VALP+1 K @PLANE@(NUMRG) S @PLANR@(@PLANR)=NUMRG,@PLANR=@PLANR+1 D ININIV
 I ECHEC=1,$D(@PLAN@(PERE,BONMAL,NUMRG)) S @PLAN@(PERE,BONMAL,NUMRG)=VALP-1
...
TRTEXD 
 ...
 S @PLANR@(@PLANR)=NUMRG,@PLANR=@PLANR+1 D ININIV
