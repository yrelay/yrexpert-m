...
;%TLIACT0^INT^1^59547,74029^0
%TLIACT0 ;;05:35 PM  21 Oct 1993; ; 25 Oct 93 10:18 AM
...
GOCOMPI 
 I $D(^TOZE(QUI,"ROUTINES")),^TOZE(QUI,"ROUTINES") G GOCOMPI^%TLIACOP
...
NXIEL X EXEVISU,^[QUI]RQSDON("COMPTRT",PARCO("TRT"),PARCO("REG"),PARCO("IEL"))
 I WHOIS("ETUDE")'=0,WHOIS("MOTEUR")="TRAITEMENT",(PARCO("TRT")'=PAREXE("TRT"))!(PARCO("REG")'=PAREXE("REG")) D AVANTI^%QXPETU(WHOIS("ETUDE")),JOURN^%QXPETU(^[QUI]TTL(PAREXE("TRT"),2,PAREXE("REG")))
 ...
 S PARCO("IEL")=$O(^[QUI]RQSDON("COMPTRT",PARCO("TRT"),PARCO("REG"),PARCO("IEL"))) G:PARCO("IEL")'="" NXIEL
...
PLANIFS(TRT,REG) 
 I WHOIS("ETUDE")'=0,WHOIS("MOTEUR")="TRAITEMENT" D AVANTI^%QXPETU(WHOIS("ETUDE")),JOURN^%QXPETU(^[QUI]TTL(TRT,2,REG))
