...
;%TXBM5^INT^1^59547,74031^0
%TXBM5 ;;09:56 AM  5 Oct 1993; ; 26 Mar 93  4:18 PM
...
INITMSQ 
 ...
 S @GLO@("H")=2,@GLO@("V")=2
 S @GLO@("NBC")=NBC
 S @GLO@("CHAMPS",1)="numero de livraison"
 S @GLO@("CHAMPS",2)="numero de commande"
 S @GLO@("CHAMPS",3)="article"
 S @GLO@("CHAMPS",4)="numero de contrat"
...
s F I=1:1:NBC S J=I+1 S:J>NBC J=1 S @GLO@("SUIV",I)=J,@GLO@("PREC",J)=I
 S @GLO@("POP1")="",@GLO@("POP2")=""
