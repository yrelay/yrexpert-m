...
loop s tdeb=1
 ...
 i '($d(@PRD@(tdeb))) w "***aucun " g loop
 w !,! s rdeb="" f z=1:1 s rdeb=$o(@PRD@(tdeb,rdeb)) q:rdeb=""  w !," ",rdeb s il=@PRD@(tdeb,rdeb) w " ",@prd@(il,9),!
 r *uuu w !,!,!
 ...
 g loop
loop1 s dt=0,DT=0
 f i=1:1:PMAX d PERIODE(t1,rdeb)
 q
PERIODE(t,r) 
