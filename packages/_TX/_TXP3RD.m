...
;%TXP3RD^INT^1^59547,74032^0
%TXP3RD(t,rfixe,PB) ;;06:20 PM  3 May 1993; ; 25 Jun 93  5:34 PM
 n RMIN,RMAX,rr,ILIGN
...
bcqx s rmod=(r+q)-d g:rmod<0 incqx
 ...
 s pbza=0
LOOPZA l +@PRD@(t+1,r1):1 e  d M^%TXP1RD("tentative de prise sur @PRD@("_(t+1)_","_r1_")") s pbza=1 g LOOPZA
 i pbza d M^%TXP1RD("                                                           ")
 
 
 i '($d(@PRD@(t+1,r1))) s valtx=$$CALCUL(t+1,rmod,r1,PB,RMIN2,RMAX2) i valtx'<VLIMI l -@PRD@(t+1,r1) s fmi=VLIMI g retf
