...
;%TXPKSA1^INT^1^59547,74032^0
%TXPKSA1 ;;06:16 PM  2 Feb 1993; 08 Jan 93  4:47 PM ; 02 Feb 93  6:16 PM
...
SAISIE(REP,IND,ATT,VALDEF,TITRE,IDEB,IFIN,REPCODE,INDCODE,ATTCODE) 
 ...
 S @GLODEFA@("ROULIB")="$$vstoctr^%TXPKSA1"
 S @GLODEFA@("ROUAFF")=$S(REPCODE="":"$$vaffctr^%TXPKSA1",1:"$$vaffcode^%TXPKSA1")
 S @GLODEFA@("ROUDEF")="$$vdef^%TXPKSA1"
