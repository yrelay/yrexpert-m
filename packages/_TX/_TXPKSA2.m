...
;%TXPKSA2^INT^1^59547,74032^0
%TXPKSA2 ;;06:33 PM  2 Feb 1993; 08 Jan 93  4:47 PM ; 04 Feb 93  7:41 PM
...
SAISIE(REPART,ART,ATT1,ATT2,FIXE1,titre,PREMX,DERX,REPCODE,INDCODE,ATTCODE) 
 N GSTO,e,em,eM,PMAX
 S PMAX=DERX-PREMX
...
MAKELIG 
 S @MATAF@(%II,1)=$S(REPCODE="":"Periode "_(((PERDP+%II)+PREMX)-1),1:$$GET(((PERDP+%II)+PREMX)-1))
