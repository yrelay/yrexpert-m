...
;%TXPPAS1^INT^1^59547,74033^0
%TXPPAS1 ;;04:03 PM  26 Jun 1992; ; 26 Jun 92  4:04 PM
 k ^qtof s garde="",z=""
 o 10:("r":"bi71")
 o 11:("w":"bi71w.dat")
loop u 10 r x
 s STATUS=$zdev("R",10),ST=$p(STATUS,",",1) g:ST=3 fin g:$a(x)=26 fin
 i (x["SPM")&(x'["TOTAL") s spm=$p(x,"SPM ",2),spm=$p(spm," ",1) g loop
