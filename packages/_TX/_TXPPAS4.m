...
;%TXPPAS4^INT^1^59547,74033^0
%TXPPAS4 ;;02:11 PM  5 Sep 1992; ; 26 Jun 92  4:05 PM
...
loop u 10 r x1,x
 ...
 s ARTICLE=$e(ARTICLE,1,6) u 0 w ARTICLE,"<<<",!
 u 0 w !,"l'article",ARTICLE," ",qtof," ",qt," existe dans les 14 "
 
 
 
 s @etud@(ARTICLE,"Commentaire")=$s($d(^les14(ARTICLE)):^les14(ARTICLE),1:"passerelle") i '($d(^les14(ARTICLE))) s ^poicout(ARTICLE)="1~1"
 ...
 s @etud@(ARTICLE,"DMD","DEMANDE","Periode "_17)=0
 g loop
