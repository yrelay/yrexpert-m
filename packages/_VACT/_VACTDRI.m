...
B S:'($D(RM)) RM=80 O 0 K ^TOLISRAM($I,10)
 ...
 D ^%VZCD(0,38,0,4,1,1,MSG) S DY=22,DX=27 X XY W $$^%QZCHW($$PCONF^%INCASTO("NOMHOST")_" - YEXPERT ("_^INCONNE("VERSION")_")") D ZD^%QMDATE4,^%QMDAK0 S DY=22,DX=0 X XY W $$^%QZCHW("le "),%DAT,"  ",HEURE S DX=75 X XY W WHOIS S DX=5,DY=3 X ^TOLISRAM(5),^TOLISRAM S DX=5,DY=3 X XY
