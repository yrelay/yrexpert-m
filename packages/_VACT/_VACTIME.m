...
AFIMEN ;Affiche entête, pied de page et cadre
 ...
 ;HL003 D CLEPAG^%VVIDEO S MSG=$$^%QZCHW(^MN(MA,"TITRE")) D ^%VZCD(0,38,0,4,1,1,MSG),^%QMDAK0,ZD^%QMDATE4 S DX=0,DY=23 X XY W "le "_%DAT_"  "_HEURE,?27,$$PCONF^%INCASTO("NOMHOST")_" - YREXPERT ("_^INCONNE("VERSION")_")",?75,WHOIS
 D CLEPAG^%VVIDEO S MSG=$$^%QZCHW(^MN(MA,"TITRE")) D ^%VZCD(0,40,0,4,1,1,MSG),^%QMDAK0,ZD^%QMDATE4 S DX=1,DY=22 X XY W "le "_%DAT_"  "_HEURE,?27,$$PCONF^%INCASTO("NOMHOST")_" - YREXPERT ("_^INCONNE("VERSION")_")",?75,WHOIS
