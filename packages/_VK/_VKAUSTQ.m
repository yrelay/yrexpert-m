...
AUTOSTOQ ;
 ...
 I %NFU="" D ^%QUERSTOC Q
 D GTSFRESU(.RESUL,.FRESU),AUTOST(.%NFU,.SCR,.FRESU)
 D ^%QUERSTOC K AFRESU S %12=-1 F %11=1:1 S %12=$N(FRESU(%12)) Q:%12=-1  S AFRESU(%12)=FRESU(%12) K FRESU(%12)
 K %11,%12 Q
...
REFUL D ^%VSQUEAK,POCLEPA^%VVIDEO W "Informations trop abondantes : veuillez abreger les champs " H 2
 ...
 H 2 D ^%VAFIGRI,^%VAFISCR S IC=1,ABENDSCR=0 D ^%VKMODIS G AUTOSTOQ:ABENDSCR=0 Q
REFUS D ^%VSQUEAK,POCLEPA^%VVIDEO W "Il faut obligatoirement une information dans  ",^%SCRE(SCR,IC,1) H 2 D ^%VAFIGRI,^%VAFISCR S ABENDSCR=0 D LOOP^%VKMODIS G AUTOSTOQ:ABENDSCR=0 Q
