...
;%VKCOR2^INT^1^59547,74035^0
CMSCOR2 ;;08:22 AM  20 Apr 1989
...
LOOP2 S %AJCMS="Cons/Mod/Supp" D ^%VATYPA
 R *X1:^TOZE($I,"ATTENTE")
 ;;DTM
 G:$$FLECHE^%INCCLAV(X1,.X1,%AJCMS,.ISN) REFUS
 D TOUCHE^%INCCLAV(X1,.X1)
 ;;FINDTM
 S:X1=-1 X1=1 G IMPR:X1=10,FIN:X1=6,FIN:X1<2 S:X1>91 X1=X1-32
