...
;DTLIGL^INT^1^59547,74866^0
%ZRECUGL ;
 K ^ERREUR($J) S %NBERR=0 W !,"Reception de global d'un autre ordinateur ",!,! D ^%IS C IO O IO:(0:1) U IO:(0:"IS":$C(13)) W *-1 U 0:("":"B") W *-1
...
OK W !,"Affecte : ",%T,"=",%RS S $ZT="G ERR",@%T=%RS U IO:(0:"IS":$C(13)) W "SUITE",$C(13) G SUITE
